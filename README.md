...
All native modules are **user‑provided** and are not included for safety, legality, and GitHub policy compliance.

## ⚙️ Features
- Custom WinForms interface
...
## 📌 What this code does (wont work because no dlls)
1. Inject
2. Get the code you wrote
3. Execute code
